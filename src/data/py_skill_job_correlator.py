...
def correlate_job(
    ...
    jobbankjobs_dir = cfg['jobbankjobs_dir']
    ...
    corr_path = correlation_json_path(jobbankjobs_dir, year, month, day, candidate, employer, job_title)
    letter_path = cover_letter_json_path(jobbankjobs_dir, year, month, day, candidate, employer, job_title)
