...
**Task:** A discrete unit of work within a project, represented as an H5 heading. Tasks are completed sequentially and do not move through separate lifecycle stages.
...
- **Action Completion:** All actions within all tasks of a project must be completed before moving the project to Complete
...
## Dictionary: Core Planning Topics

Use the following concepts and terms to guide roadmap and planning documentation.

**Development Goals Tracking** — Project-based tracking in markdown (Development Goals, tasks, actions) with WIP limits and structured metadata.

**Roadmap Phases** — Initial Development, Post-Launch, and Maintenance & Growth planning approaches and guidance for each phase.

**Decision Documentation** — ADRs, decision rationale, and linkage between roadmap items and architectural decisions.

**Validation & Governance** — Programmatic validation schema, metadata checks, and update rules for maintaining roadmap integrity.
